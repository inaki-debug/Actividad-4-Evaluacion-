...
syms th0(t) th1(t) th2(t) th3(t) th4(t) th5(t) t l0 l1 l2 l3 l4 l5
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
P(:,:,3)= [l2*sin(th2); l2*cos(th2);0];
%Matriz de rotación de la junta 2 respecto a 1
R(:,:,3)= [cos(th2) 0  -sin(th2);
           sin(th2) 0  cos(th2);
           0        -1         0];
...
P(:,:,5)= [-l4*sin(th4); l4*cos(th4);0];
%Matriz de rotación de la junta 2 respecto a 1
R(:,:,5)= [0 -sin(th4)  -cos(th4);
           0  cos(th4)  -sin(th4);
           1         0         0];
